...
export const digitalAnanlogWritePinPosition: PositionComponent<WritePinState> = (
    ...
    if (area) {
        ...
        positionComponent(componentEl, arduinoEl, draw, "POWER");
    }
};
...
export const createWiresDigitalAnalogWrite: CreateWire<WritePinState> = (
    ...
    if (area) {
        ...
        createGroundOrPowerWireArduino(draw, arduino as Svg, board.writePin as ARDUINO_PINS, componentEl, board, "ground")
