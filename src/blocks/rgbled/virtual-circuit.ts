...
export const positionRgbLed: PositionComponent<LedColorState> = (
    ...
    if (area) {
        ...
        positionComponent(rgbLedEl, arduinoEl, draw, "PIN_POWER");
    }
};
...
export const createWiresRgbLed: CreateWire<LedColorState> = (
    ...
    if (area) {
        ...
        createFromArduinoToComponent(draw, arduino as Svg, state.redPin, rgbLedEl, "PIN_RED", board, "#FF0000");
        createFromArduinoToComponent(draw, arduino as Svg, state.bluePin, rgbLedEl, "PIN_BLUE", board, "#0000FF");
        createFromArduinoToComponent(draw, arduino as Svg, state.greenPin, rgbLedEl, "PIN_GREEN", board, "#00FF00");
    }
